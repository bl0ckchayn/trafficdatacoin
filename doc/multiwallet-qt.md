...
In order to support loading of multiple wallets in tdc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tdc.cpp.
...
Changes to tdc.cpp
----------------------
tdc.cpp is the entry point into tdc-qt, and as such, will require some minor modifications to provide hooks for
