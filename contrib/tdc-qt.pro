...
RESOURCES += src/qt/tdc.qrc src/qt/tdc_locale.qrc

TRANSLATIONS += src/qt/locale/tdc_bg.ts \
                src/qt/locale/tdc_de.ts \
                src/qt/locale/tdc_en.ts \
                src/qt/locale/tdc_es.ts \
                src/qt/locale/tdc_fi.ts \
                src/qt/locale/tdc_fr.ts \
                src/qt/locale/tdc_it.ts \
                src/qt/locale/tdc_ja.ts \
                src/qt/locale/tdc_pl.ts \
                src/qt/locale/tdc_pt.ts \
                src/qt/locale/tdc_ru.ts \
                src/qt/locale/tdc_sk.ts \
                src/qt/locale/tdc_sv.ts \
                src/qt/locale/tdc_vi.ts \
                src/qt/locale/tdc_zh_CN.ts \
                src/qt/locale/tdc_zh_TW.ts
