                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TrafficDataCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TDC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tdc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TDC Core"), this);
    aboutAction->setStatusTip(tr("Show information about TDC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TDC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TDC addresses"));
    ...
    openAction->setStatusTip(tr("Open a TDC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TDC Core help message to get a list with possible TDC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TDC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TDC network", "", count));
}
...
{
    QString strTitle = tr("TDC Core"); // default title
