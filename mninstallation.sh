...
COIN_REPO='https://github.com/trafficdatacoin/trafficdatacoin.git'
COIN_TGZ='https://github.com/trafficdatacoin/trafficdatacoin/releases/download/v1.0/tdc-linux.tgz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='TrafficDataCoin'
COIN_PORT=17281
RPC_PORT=18937
